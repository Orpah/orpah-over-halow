...
| 客户端设备仿真器（设备侧旋钮/单一源守卫） | `test_client_sim.py` | ✅ PASS | 6.6s | 通过 |
...
### 客户端设备仿真器（设备侧旋钮/单一源守卫） — PASS（6.6s）
...
### 防 spoof 空口端到端 — PASS（1.7s）
      ...
      攻击者 SN    : CN-WH01-A9MQYYAZ02-65（未登记 → 服务器不认识）
